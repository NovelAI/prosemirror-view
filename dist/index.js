...
import { DOMSerializer, Fragment, Mark, Node, Slice, DOMParser } from 'prosemirror-model';
...
function resetScrollPos(view, { refDOM, refTop, stack, heightBefore, scrollBefore }) {
...
function doPaste(view, text, html, preferPlain, event) {
    // @ts-ignore
    let slice = parseFromClipboard(view, text, html, view.someProp("plainTextPaste") || preferPlain, view.state.selection.$from);
