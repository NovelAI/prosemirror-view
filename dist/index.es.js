...
import { DOMSerializer, Fragment, Mark, DOMParser, Node, Slice } from 'prosemirror-model';
...
function serializeForClipboard(view, slice) {
  ...
  var contentClean = Fragment.fromJSON(content.toJSON());
  var removeIndices = [];
...
function capturePaste(view, e) {
  if (!view.dom.parentNode) { return }
  var plainText = view.someProp("plainTextPaste") || view.shiftKey || view.state.selection.$from.parent.type.spec.code;
...
function doPaste(view, text, html, e) {
  var slice = parseFromClipboard(view, text, html, view.someProp("plainTextPaste") || view.shiftKey, view.state.selection.$from);
